...
export const inRatioElement = document.getElementById('in-ratio')!
export const outRatioElement = document.getElementById('out-ratio')!

export const paiElement = document.getElementById('pai')!
